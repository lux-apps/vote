import { BaseError, ContractFunctionRevertedError, encodeAbiParameters, encodePacked, decodeEventLog } from 'viem';
import { z } from 'zod';
...
const AddressSchema = z
    ...
    .describe("string");
const BooleanSchema = z.boolean().describe("boolean");
const StringSchema = z.string().describe("string");
const Bytes1Schema = z
    .string()
    .regex(/^0x[a-fA-F0-9]{2}$/)
    .describe("bigint");
const Bytes2Schema = z
    .string()
    .regex(/^0x[a-fA-F0-9]{4}$/)
    .describe("bigint");
const Bytes3Schema = z
    .string()
...
const Bytes4Schema = z
    ...
    .describe("bigint");
const Bytes5Schema = z
    .string()
    .regex(/^0x[a-fA-F0-9]{10}$/)
    .describe("bigint");
const Bytes6Schema = z
    .string()
    .regex(/^0x[a-fA-F0-9]{12}$/)
    .describe("bigint");
const Bytes7Schema = z
    .string()
    .regex(/^0x[a-fA-F0-9]{14}$/)
    .describe("bigint");
const Bytes8Schema = z
    .string()
    .regex(/^0x[a-fA-F0-9]{16}$/)
    .describe("bigint");
const Bytes9Schema = z
    .string()
    .regex(/^0x[a-fA-F0-9]{18}$/)
    .describe("bigint");
const Bytes10Schema = z
    .string()
    .regex(/^0x[a-fA-F0-9]{20}$/)
    .describe("bigint");
const Bytes11Schema = z
    .string()
    .regex(/^0x[a-fA-F0-9]{22}$/)
    .describe("bigint");
const Bytes12Schema = z
    .string()
    .regex(/^0x[a-fA-F0-9]{24}$/)
    .describe("bigint");
const Bytes13Schema = z
    .string()
    .regex(/^0x[a-fA-F0-9]{26}$/)
    .describe("bigint");
const Bytes14Schema = z
    .string()
    .regex(/^0x[a-fA-F0-9]{28}$/)
    .describe("bigint");
const Bytes15Schema = z
    .string()
    .regex(/^0x[a-fA-F0-9]{30}$/)
    .describe("bigint");
const Bytes16Schema = z
    .string()
    .regex(/^0x[a-fA-F0-9]{32}$/)
    .describe("bigint");
const Bytes17Schema = z
    .string()
    .regex(/^0x[a-fA-F0-9]{34}$/)
    .describe("bigint");
const Bytes18Schema = z
    .string()
    .regex(/^0x[a-fA-F0-9]{36}$/)
    .describe("bigint");
const Bytes19Schema = z
    .string()
    .regex(/^0x[a-fA-F0-9]{38}$/)
    .describe("bigint");
const Bytes20Schema = z
    .string()
    .regex(/^0x[a-fA-F0-9]{40}$/)
    .describe("bigint");
const Bytes21Schema = z
    .string()
    .regex(/^0x[a-fA-F0-9]{42}$/)
    .describe("bigint");
const Bytes22Schema = z
    .string()
    .regex(/^0x[a-fA-F0-9]{44}$/)
    .describe("bigint");
const Bytes23Schema = z
    .string()
    .regex(/^0x[a-fA-F0-9]{46}$/)
    .describe("bigint");
const Bytes24Schema = z
    .string()
    .regex(/^0x[a-fA-F0-9]{48}$/)
    .describe("bigint");
const Bytes25Schema = z
    .string()
    .regex(/^0x[a-fA-F0-9]{50}$/)
    .describe("bigint");
const Bytes26Schema = z
    .string()
    .regex(/^0x[a-fA-F0-9]{52}$/)
    .describe("bigint");
const Bytes27Schema = z
    .string()
    .regex(/^0x[a-fA-F0-9]{54}$/)
    .describe("bigint");
const Bytes28Schema = z
    .string()
    .regex(/^0x[a-fA-F0-9]{56}$/)
    .describe("bigint");
const Bytes29Schema = z
    .string()
    .regex(/^0x[a-fA-F0-9]{58}$/)
    .describe("bigint");
const Bytes30Schema = z
    .string()
    .regex(/^0x[a-fA-F0-9]{60}$/)
    .describe("bigint");
const Bytes31Schema = z
    .string()
...
const BytesSchema = z
    ...
    .describe("bigint");
// Uint array
const ArrayUint8Schema = z.array(Uint8Schema).describe("number[]");
const ArrayUint16Schema = z.array(Uint16Schema).describe("number[]");
const ArrayUint24Schema = z.array(Uint24Schema).describe("number[]");
const ArrayUint32Schema = z.array(Uint32Schema).describe("number[]");
const ArrayUint40Schema = z.array(Uint40Schema).describe("number[]");
const ArrayUint48Schema = z.array(Uint48Schema).describe("number[]");
const ArrayUint56Schema = z.array(Uint56Schema).describe("bigint[]");
const ArrayUint64Schema = z.array(Uint64Schema).describe("bigint[]");
const ArrayUint72Schema = z.array(Uint72Schema).describe("bigint[]");
const ArrayUint80Schema = z.array(Uint80Schema).describe("bigint[]");
const ArrayUint88Schema = z.array(Uint88Schema).describe("bigint[]");
const ArrayUint96Schema = z.array(Uint96Schema).describe("bigint[]");
const ArrayUint104Schema = z.array(Uint104Schema).describe("bigint[]");
const ArrayUint112Schema = z.array(Uint112Schema).describe("bigint[]");
const ArrayUint120Schema = z.array(Uint120Schema).describe("bigint[]");
const ArrayUint128Schema = z.array(Uint128Schema).describe("bigint[]");
const ArrayUint136Schema = z.array(Uint136Schema).describe("bigint[]");
const ArrayUint144Schema = z.array(Uint144Schema).describe("bigint[]");
const ArrayUint152Schema = z.array(Uint152Schema).describe("bigint[]");
const ArrayUint160Schema = z.array(Uint160Schema).describe("bigint[]");
const ArrayUint168Schema = z.array(Uint168Schema).describe("bigint[]");
const ArrayUint176Schema = z.array(Uint176Schema).describe("bigint[]");
const ArrayUint184Schema = z.array(Uint184Schema).describe("bigint[]");
const ArrayUint192Schema = z.array(Uint192Schema).describe("bigint[]");
const ArrayUint200Schema = z.array(Uint200Schema).describe("bigint[]");
const ArrayUint208Schema = z.array(Uint208Schema).describe("bigint[]");
const ArrayUint216Schema = z.array(Uint216Schema).describe("bigint[]");
const ArrayUint224Schema = z.array(Uint224Schema).describe("bigint[]");
const ArrayUint232Schema = z.array(Uint232Schema).describe("bigint[]");
const ArrayUint240Schema = z.array(Uint240Schema).describe("bigint[]");
const ArrayUint248Schema = z.array(Uint248Schema).describe("bigint[]");
const ArrayUint256Schema = z.array(Uint256Schema).describe("bigint[]");
// Int array
const ArrayInt8Schema = z.array(Int8Schema).describe("number[]");
const ArrayInt16Schema = z.array(Int16Schema).describe("number[]");
const ArrayInt24Schema = z.array(Int24Schema).describe("number[]");
const ArrayInt32Schema = z.array(Int32Schema).describe("number[]");
const ArrayInt40Schema = z.array(Int40Schema).describe("number[]");
const ArrayInt48Schema = z.array(Int48Schema).describe("number[]");
const ArrayInt56Schema = z.array(Int56Schema).describe("bigint[]");
const ArrayInt64Schema = z.array(Int64Schema).describe("bigint[]");
const ArrayInt72Schema = z.array(Int72Schema).describe("bigint[]");
const ArrayInt80Schema = z.array(Int80Schema).describe("bigint[]");
const ArrayInt88Schema = z.array(Int88Schema).describe("bigint[]");
const ArrayInt96Schema = z.array(Int96Schema).describe("bigint[]");
const ArrayInt104Schema = z.array(Int104Schema).describe("bigint[]");
const ArrayInt112Schema = z.array(Int112Schema).describe("bigint[]");
const ArrayInt120Schema = z.array(Int120Schema).describe("bigint[]");
const ArrayInt128Schema = z.array(Int128Schema).describe("bigint[]");
const ArrayInt136Schema = z.array(Int136Schema).describe("bigint[]");
const ArrayInt144Schema = z.array(Int144Schema).describe("bigint[]");
const ArrayInt152Schema = z.array(Int152Schema).describe("bigint[]");
const ArrayInt160Schema = z.array(Int160Schema).describe("bigint[]");
const ArrayInt168Schema = z.array(Int168Schema).describe("bigint[]");
const ArrayInt176Schema = z.array(Int176Schema).describe("bigint[]");
const ArrayInt184Schema = z.array(Int184Schema).describe("bigint[]");
const ArrayInt192Schema = z.array(Int192Schema).describe("bigint[]");
const ArrayInt200Schema = z.array(Int200Schema).describe("bigint[]");
const ArrayInt208Schema = z.array(Int208Schema).describe("bigint[]");
const ArrayInt216Schema = z.array(Int216Schema).describe("bigint[]");
const ArrayInt224Schema = z.array(Int224Schema).describe("bigint[]");
const ArrayInt232Schema = z.array(Int232Schema).describe("bigint[]");
const ArrayInt240Schema = z.array(Int240Schema).describe("bigint[]");
const ArrayInt248Schema = z.array(Int248Schema).describe("bigint[]");
const ArrayInt256Schema = z.array(Int256Schema).describe("bigint[]");
// Bytes Array
const ArrayBytes1Schema = z.array(Bytes1Schema).describe("string[]");
const ArrayBytes2Schema = z.array(Bytes2Schema).describe("string[]");
const ArrayBytes3Schema = z.array(Bytes3Schema).describe("string[]");
const ArrayBytes4Schema = z.array(Bytes4Schema).describe("string[]");
const ArrayBytes5Schema = z.array(Bytes5Schema).describe("string[]");
const ArrayBytes6Schema = z.array(Bytes6Schema).describe("string[]");
const ArrayBytes7Schema = z.array(Bytes7Schema).describe("string[]");
const ArrayBytes8Schema = z.array(Bytes8Schema).describe("string[]");
const ArrayBytes9Schema = z.array(Bytes9Schema).describe("string[]");
const ArrayBytes10Schema = z.array(Bytes10Schema).describe("string[]");
const ArrayBytes11Schema = z.array(Bytes11Schema).describe("string[]");
const ArrayBytes12Schema = z.array(Bytes12Schema).describe("string[]");
const ArrayBytes13Schema = z.array(Bytes13Schema).describe("string[]");
const ArrayBytes14Schema = z.array(Bytes14Schema).describe("string[]");
const ArrayBytes15Schema = z.array(Bytes15Schema).describe("string[]");
const ArrayBytes16Schema = z.array(Bytes16Schema).describe("string[]");
const ArrayBytes17Schema = z.array(Bytes17Schema).describe("string[]");
const ArrayBytes18Schema = z.array(Bytes18Schema).describe("string[]");
const ArrayBytes19Schema = z.array(Bytes19Schema).describe("string[]");
const ArrayBytes20Schema = z.array(Bytes20Schema).describe("string[]");
const ArrayBytes21Schema = z.array(Bytes21Schema).describe("string[]");
const ArrayBytes22Schema = z.array(Bytes22Schema).describe("string[]");
const ArrayBytes23Schema = z.array(Bytes23Schema).describe("string[]");
const ArrayBytes24Schema = z.array(Bytes24Schema).describe("string[]");
const ArrayBytes25Schema = z.array(Bytes25Schema).describe("string[]");
const ArrayBytes26Schema = z.array(Bytes26Schema).describe("string[]");
const ArrayBytes27Schema = z.array(Bytes27Schema).describe("string[]");
const ArrayBytes28Schema = z.array(Bytes28Schema).describe("string[]");
const ArrayBytes29Schema = z.array(Bytes29Schema).describe("string[]");
const ArrayBytes30Schema = z.array(Bytes30Schema).describe("string[]");
const ArrayBytes31Schema = z.array(Bytes31Schema).describe("string[]");
const ArrayBytes32Schema = z.array(Bytes32Schema).describe("string[]");
const ArrayBytesSchema = z.array(BytesSchema).describe("string[]");
// String array
const ArrayStringSchema = z.array(StringSchema).describe("string[]");
// Boolean array
const ArrayBooleanSchema = z.array(BooleanSchema).describe("boolean[]");
// Address array
const ArrayAddressSchema = z.array(AddressSchema).describe("string[]");
const typeToSchema = {
...
export { HATS_ELIGIBILITIES_CHAIN_MODULE_ABI, HATS_ELIGIBILITIES_CHAIN_MODULE_ADDRESS, HATS_MODULES_FACTORY_ABI, HATS_MODULES_FACTORY_ADDRESS, HATS_MODULE_ABI, HATS_TOGGLES_CHAIN_MODULE_ABI, HATS_TOGGLES_CHAIN_MODULE_ADDRESS, HatsModulesClient, checkAndEncodeArgs, checkImmutableArgs, checkMutableArgs, getNewInstancesFromReceipt, getSchema, solidityToTypescriptType, verify };
