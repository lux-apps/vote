...
type CloudflareSpaConfig = Partial<ResolvedCloudflareSpaConfig>;
type ResolvedCloudflareSpaConfig = {
    /**
...
declare const viteWranglerSpa: (config?: CloudflareSpaConfig) => import("vite").PluginOption[];
