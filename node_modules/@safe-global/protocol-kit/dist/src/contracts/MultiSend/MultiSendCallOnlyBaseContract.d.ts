 ...
 */
declare abstract class MultiSendCallOnlyBaseContract<MultiSendCallOnlyContractAbiType extends InterfaceAbi & Abi> extends BaseContract<MultiSendCallOnlyContractAbiType> {
     ...
     */
    constructor(chainId: bigint, safeProvider: SafeProvider, defaultAbi: MultiSendCallOnlyContractAbiType, safeVersion: SafeVersion, customContractAddress?: string, customContractAbi?: MultiSendCallOnlyContractAbiType);
}
