 ...
 */
declare abstract class SafeProxyFactoryBaseContract<SafeProxyFactoryContractAbiType extends InterfaceAbi & Abi> extends BaseContract<SafeProxyFactoryContractAbiType> {
     ...
     */
    constructor(chainId: bigint, safeProvider: SafeProvider, defaultAbi: SafeProxyFactoryContractAbiType, safeVersion: SafeVersion, customContractAddress?: string, customContractAbi?: SafeProxyFactoryContractAbiType, runner?: ContractRunner | null);
}
