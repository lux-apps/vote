...
class SafeProvider {
    constructor({ provider, signer }) {
        ...
        if (typeof provider === 'string') {
            __classPrivateFieldSet(this, _SafeProvider_externalProvider, new ethers_1.JsonRpcProvider(provider), "f");
        }
        else {
    ...
    async getExternalSigner() {
        ...
        if (this.signer && !ethers_1.ethers.isAddress(this.signer)) {
