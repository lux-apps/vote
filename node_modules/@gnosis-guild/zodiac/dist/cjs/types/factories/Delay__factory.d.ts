...
export declare class Delay__factory {
    static readonly abi: readonly [{
        ...
        readonly name: "TransactionAdded";
        readonly type: "event";
    }, {
        readonly inputs: readonly [];
        readonly name: "avatar";
    ...
    static connect(address: string, runner?: ContractRunner | null): Delay;
}
