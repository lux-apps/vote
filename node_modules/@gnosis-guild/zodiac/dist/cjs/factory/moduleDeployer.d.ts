...
export declare const deployAndSetUpModule: (moduleName: KnownContracts, setupArgs: {
    types: Array<string>;
    values: Array<any>;
}, provider: Provider, chainId: number, saltNonce: string) => Promise<{
    transaction: {
        data: string;
        to: string;
        value: bigint;
...
export declare const deployAndSetUpCustomModule: (mastercopyAddress: string, abi: ABI, setupArgs: {
    types: Array<string>;
    values: Array<any>;
}, provider: Provider, chainId: number, saltNonce: string) => Promise<TxAndExpectedAddress>;
export declare const calculateProxyAddress: (moduleFactory: Contract, mastercopyAddress: string, initData: string, saltNonce: string) => Promise<string>;
export declare const getModuleInstance: <T extends KnownContracts>(moduleName: T, moduleAddress: string, provider: Provider | Signer) => ReturnType<{
    ...
    roles_v2: typeof import("../types").RolesV2__factory;
