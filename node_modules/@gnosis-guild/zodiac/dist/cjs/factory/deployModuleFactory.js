...
(0, assert_1.default)(FactoryInitData);
/**
...
const deployModuleFactory = async (signer) => {
    ...
    const targetAddress = await singletonFactory.deploy.staticCall(FactoryInitData.initCode, FactoryInitData.salt);
    if (targetAddress === AddressZero) {
        console.log(`  ✔ Module Proxy Factory already deployed to target address on ${(await signer.provider.getNetwork()).name}.`);
        return AddressZero;
    }
