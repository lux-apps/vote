import { BytesLike, ContractFactory, JsonRpcSigner } from "ethers";
/**
 ...
 */
export declare const deployMastercopy: (signer: JsonRpcSigner, mastercopyContractFactory: ContractFactory, args: Array<any>, salt: string) => Promise<string>;
/**
 ...
 * }
 */
export declare const computeTargetAddress: (signer: JsonRpcSigner, mastercopyContractFactory: ContractFactory, args: Array<any>, salt: string) => Promise<{
    address: string;
    isDeployed: boolean;
}>;
export declare const deployMastercopyWithInitData: (signer: JsonRpcSigner, initCode: BytesLike, salt: string) => Promise<string>;
