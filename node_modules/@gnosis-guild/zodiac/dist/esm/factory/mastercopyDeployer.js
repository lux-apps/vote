...
import { ZeroAddress, keccak256, getAddress, getCreate2Address, } from "ethers";
...
export const deployMastercopy = (signer, mastercopyContractFactory, args, salt) => __awaiter(void 0, void 0, void 0, function* () {
    const deploymentTx = yield mastercopyContractFactory.getDeployTransaction(...args);
...
export const computeTargetAddress = (signer, mastercopyContractFactory, args, salt) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const computedAddress = getCreate2Address(yield singletonFactory.getAddress(), salt, initCodeHash);
    const targetAddress = getAddress((yield singletonFactory.deploy.staticCall(deploymentTx.data, salt)));
    // Sanity check
...
export const deployMastercopyWithInitData = (signer, initCode, salt) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const targetAddress = getAddress((yield singletonFactory.deploy.staticCall(initCode, salt)));
    const initCodeHash = keccak256(initCode);
    const computedTargetAddress = getCreate2Address(yield singletonFactory.getAddress(), salt, initCodeHash);
    ...
    let gasLimit;
    switch ((yield signer.provider.getNetwork()).name) {
        case "optimism":
            gasLimit = 6000000;
            break;
        case "arbitrum":
