...
export const deployModuleFactory = (signer) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const targetAddress = yield singletonFactory.deploy.staticCall(FactoryInitData.initCode, FactoryInitData.salt);
    if (targetAddress === AddressZero) {
        console.log(`  ✔ Module Proxy Factory already deployed to target address on ${(yield signer.provider.getNetwork()).name}.`);
        return AddressZero;
    }
