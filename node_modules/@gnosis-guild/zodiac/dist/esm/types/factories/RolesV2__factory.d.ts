...
import type { RolesV2, RolesV2Interface } from "../RolesV2";
export declare class RolesV2__factory {
    ...
    static createInterface(): RolesV2Interface;
    static connect(address: string, runner?: ContractRunner | null): RolesV2;
}
