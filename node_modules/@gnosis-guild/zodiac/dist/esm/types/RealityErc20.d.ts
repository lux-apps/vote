...
export interface RealityErc20Interface extends Interface {
    ...
    encodeFunctionData(functionFragment: "generateTransactionHashData", values: [AddressLike, BigNumberish, BytesLike, BigNumberish, BigNumberish]): string;
    ...
    encodeFunctionData(functionFragment: "getTransactionHash", values: [AddressLike, BigNumberish, BytesLike, BigNumberish, BigNumberish]): string;
...
export declare namespace ProposalQuestionCreatedEvent {
    type InputTuple = [questionId: BytesLike, proposalId: string];
    type OutputTuple = [questionId: string, proposalId: string];
    interface OutputObject {
        questionId: string;
        proposalId: string;
    }
...
export declare namespace RealityModuleSetupEvent {
    type InputTuple = [
...
export interface RealityErc20 extends BaseContract {
    connect(runner?: ContractRunner | null): RealityErc20;
    ...
    INVALIDATED: TypedContractMethod<[], [string], "view">;
    TRANSACTION_TYPEHASH: TypedContractMethod<[], [string], "view">;
    ...
    addProposalWithNonce: TypedContractMethod<[
        proposalId: string,
        txHashes: BytesLike[],
        nonce: BigNumberish
    ], [
    ...
    answerExpiration: TypedContractMethod<[], [bigint], "view">;
    avatar: TypedContractMethod<[], [string], "view">;
    buildQuestion: TypedContractMethod<[
        proposalId: string,
        txHashes: BytesLike[]
    ], [
        string
    ...
    executeProposalWithIndex: TypedContractMethod<[
        proposalId: string,
        txHashes: BytesLike[],
        to: AddressLike,
        value: BigNumberish,
    ...
    executedProposalTransactions: TypedContractMethod<[
        arg0: BytesLike,
        arg1: BytesLike
    ], [
        boolean
    ], "view">;
    generateTransactionHashData: TypedContractMethod<[
        to: AddressLike,
        value: BigNumberish,
        data: BytesLike,
        operation: BigNumberish,
    ...
    getQuestionId: TypedContractMethod<[
        question: string,
        nonce: BigNumberish
    ], [
        string
    ...
    markProposalAsInvalid: TypedContractMethod<[
        proposalId: string,
        txHashes: BytesLike[]
    ], [
        void
    ], "nonpayable">;
    markProposalAsInvalidByHash: TypedContractMethod<[
        questionHash: BytesLike
    ], [
        void
    ], "nonpayable">;
    markProposalWithExpiredAnswerAsInvalid: TypedContractMethod<[
        questionHash: BytesLike
    ], [
        void
    ], "nonpayable">;
    minimumBond: TypedContractMethod<[], [bigint], "view">;
    oracle: TypedContractMethod<[], [string], "view">;
    owner: TypedContractMethod<[], [string], "view">;
    questionArbitrator: TypedContractMethod<[], [string], "view">;
    questionCooldown: TypedContractMethod<[], [bigint], "view">;
    questionIds: TypedContractMethod<[arg0: BytesLike], [string], "view">;
    questionTimeout: TypedContractMethod<[], [bigint], "view">;
    renounceOwnership: TypedContractMethod<[], [void], "nonpayable">;
    setAnswerExpiration: TypedContractMethod<[
    ...
    setMinimumBond: TypedContractMethod<[
        bond: BigNumberish
    ], [
        void
    ], "nonpayable">;
    setQuestionCooldown: TypedContractMethod<[
        cooldown: BigNumberish
    ], [
        void
    ], "nonpayable">;
    setQuestionTimeout: TypedContractMethod<[
    ...
    template: TypedContractMethod<[], [bigint], "view">;
    ...
    getFunction(nameOrSignature: "INVALIDATED"): TypedContractMethod<[], [string], "view">;
    getFunction(nameOrSignature: "TRANSACTION_TYPEHASH"): TypedContractMethod<[], [string], "view">;
    ...
    getFunction(nameOrSignature: "addProposalWithNonce"): TypedContractMethod<[
        proposalId: string,
        txHashes: BytesLike[],
        nonce: BigNumberish
    ], [
    ...
    getFunction(nameOrSignature: "answerExpiration"): TypedContractMethod<[], [bigint], "view">;
    getFunction(nameOrSignature: "avatar"): TypedContractMethod<[], [string], "view">;
    getFunction(nameOrSignature: "buildQuestion"): TypedContractMethod<[
        proposalId: string,
        txHashes: BytesLike[]
    ], [
        string
    ...
    getFunction(nameOrSignature: "executeProposalWithIndex"): TypedContractMethod<[
        proposalId: string,
        txHashes: BytesLike[],
        to: AddressLike,
        value: BigNumberish,
    ...
    getFunction(nameOrSignature: "executedProposalTransactions"): TypedContractMethod<[arg0: BytesLike, arg1: BytesLike], [boolean], "view">;
    getFunction(nameOrSignature: "generateTransactionHashData"): TypedContractMethod<[
        to: AddressLike,
        value: BigNumberish,
        data: BytesLike,
        operation: BigNumberish,
    ...
    getFunction(nameOrSignature: "getQuestionId"): TypedContractMethod<[
        question: string,
        nonce: BigNumberish
    ], [
        string
    ...
    getFunction(nameOrSignature: "markProposalAsInvalid"): TypedContractMethod<[
        proposalId: string,
        txHashes: BytesLike[]
    ], [
        void
    ], "nonpayable">;
    getFunction(nameOrSignature: "markProposalAsInvalidByHash"): TypedContractMethod<[questionHash: BytesLike], [void], "nonpayable">;
    getFunction(nameOrSignature: "markProposalWithExpiredAnswerAsInvalid"): TypedContractMethod<[questionHash: BytesLike], [void], "nonpayable">;
    getFunction(nameOrSignature: "minimumBond"): TypedContractMethod<[], [bigint], "view">;
    getFunction(nameOrSignature: "oracle"): TypedContractMethod<[], [string], "view">;
    getFunction(nameOrSignature: "owner"): TypedContractMethod<[], [string], "view">;
    getFunction(nameOrSignature: "questionArbitrator"): TypedContractMethod<[], [string], "view">;
    getFunction(nameOrSignature: "questionCooldown"): TypedContractMethod<[], [bigint], "view">;
    getFunction(nameOrSignature: "questionIds"): TypedContractMethod<[arg0: BytesLike], [string], "view">;
    getFunction(nameOrSignature: "questionTimeout"): TypedContractMethod<[], [bigint], "view">;
    getFunction(nameOrSignature: "renounceOwnership"): TypedContractMethod<[], [void], "nonpayable">;
    getFunction(nameOrSignature: "setAnswerExpiration"): TypedContractMethod<[expiration: BigNumberish], [void], "nonpayable">;
    getFunction(nameOrSignature: "setArbitrator"): TypedContractMethod<[arbitrator: AddressLike], [void], "nonpayable">;
    ...
    getFunction(nameOrSignature: "setMinimumBond"): TypedContractMethod<[bond: BigNumberish], [void], "nonpayable">;
    getFunction(nameOrSignature: "setQuestionCooldown"): TypedContractMethod<[cooldown: BigNumberish], [void], "nonpayable">;
    getFunction(nameOrSignature: "setQuestionTimeout"): TypedContractMethod<[timeout: BigNumberish], [void], "nonpayable">;
    getFunction(nameOrSignature: "setTarget"): TypedContractMethod<[_target: AddressLike], [void], "nonpayable">;
    getFunction(nameOrSignature: "setTemplate"): TypedContractMethod<[templateId: BigNumberish], [void], "nonpayable">;
    ...
    getFunction(nameOrSignature: "template"): TypedContractMethod<[], [bigint], "view">;
    ...
    getEvent(key: "ProposalQuestionCreated"): TypedContractEvent<ProposalQuestionCreatedEvent.InputTuple, ProposalQuestionCreatedEvent.OutputTuple, ProposalQuestionCreatedEvent.OutputObject>;
    getEvent(key: "RealityModuleSetup"): TypedContractEvent<RealityModuleSetupEvent.InputTuple, RealityModuleSetupEvent.OutputTuple, RealityModuleSetupEvent.OutputObject>;
    ...
    filters: {
        ...
        "ProposalQuestionCreated(bytes32,string)": TypedContractEvent<ProposalQuestionCreatedEvent.InputTuple, ProposalQuestionCreatedEvent.OutputTuple, ProposalQuestionCreatedEvent.OutputObject>;
        ProposalQuestionCreated: TypedContractEvent<ProposalQuestionCreatedEvent.InputTuple, ProposalQuestionCreatedEvent.OutputTuple, ProposalQuestionCreatedEvent.OutputObject>;
        "RealityModuleSetup(address,address,address,address)": TypedContractEvent<RealityModuleSetupEvent.InputTuple, RealityModuleSetupEvent.OutputTuple, RealityModuleSetupEvent.OutputObject>;
        RealityModuleSetup: TypedContractEvent<RealityModuleSetupEvent.InputTuple, RealityModuleSetupEvent.OutputTuple, RealityModuleSetupEvent.OutputObject>;
