...
export interface ExitErc721Interface extends Interface {
    getFunction(nameOrSignature: "addToDenyList" | "avatar" | "circulatingSupply" | "collection" | "deniedTokens" | "exit" | "getCirculatingSupply" | "getGuard" | "guard" | "owner" | "removeFromDenyList" | "renounceOwnership" | "setAvatar" | "setCirculatingSupply" | "setCollection" | "setGuard" | "setTarget" | "setUp" | "supportsInterface" | "target" | "transferOwnership"): FunctionFragment;
    getEvent(nameOrSignatureOrTopic: "AvatarSet" | "ChangedGuard" | "ExitModuleSetup" | "ExitSuccessful" | "OwnershipTransferred" | "TargetSet"): EventFragment;
    encodeFunctionData(functionFragment: "addToDenyList", values: [AddressLike[]]): string;
    ...
    encodeFunctionData(functionFragment: "deniedTokens", values: [AddressLike]): string;
    encodeFunctionData(functionFragment: "exit", values: [BigNumberish, AddressLike[]]): string;
    ...
    encodeFunctionData(functionFragment: "removeFromDenyList", values: [AddressLike[]]): string;
    encodeFunctionData(functionFragment: "renounceOwnership", values?: undefined): string;
    encodeFunctionData(functionFragment: "setAvatar", values: [AddressLike]): string;
    encodeFunctionData(functionFragment: "setCirculatingSupply", values: [AddressLike]): string;
    encodeFunctionData(functionFragment: "setCollection", values: [AddressLike]): string;
...
export declare namespace ExitModuleSetupEvent {
    type InputTuple = [initiator: AddressLike, avatar: AddressLike];
    type OutputTuple = [initiator: string, avatar: string];
    interface OutputObject {
        initiator: string;
        avatar: string;
    }
...
export declare namespace ExitSuccessfulEvent {
    type InputTuple = [leaver: AddressLike];
    type OutputTuple = [leaver: string];
    interface OutputObject {
        leaver: string;
    }
    type Event = TypedContractEvent<InputTuple, OutputTuple, OutputObject>;
...
export interface ExitErc721 extends BaseContract {
    connect(runner?: ContractRunner | null): ExitErc721;
    ...
    addToDenyList: TypedContractMethod<[
        tokens: AddressLike[]
    ], [
        void
    ], "nonpayable">;
    avatar: TypedContractMethod<[], [string], "view">;
    circulatingSupply: TypedContractMethod<[], [string], "view">;
    collection: TypedContractMethod<[], [string], "view">;
    deniedTokens: TypedContractMethod<[arg0: AddressLike], [boolean], "view">;
    ...
    removeFromDenyList: TypedContractMethod<[
        tokens: AddressLike[]
    ], [
        void
    ], "nonpayable">;
    ...
    setCirculatingSupply: TypedContractMethod<[
        _circulatingSupply: AddressLike
    ], [
        void
    ], "nonpayable">;
    setCollection: TypedContractMethod<[
    ...
    getFunction(nameOrSignature: "addToDenyList"): TypedContractMethod<[tokens: AddressLike[]], [void], "nonpayable">;
    getFunction(nameOrSignature: "avatar"): TypedContractMethod<[], [string], "view">;
    getFunction(nameOrSignature: "circulatingSupply"): TypedContractMethod<[], [string], "view">;
    getFunction(nameOrSignature: "collection"): TypedContractMethod<[], [string], "view">;
    getFunction(nameOrSignature: "deniedTokens"): TypedContractMethod<[arg0: AddressLike], [boolean], "view">;
    ...
    getFunction(nameOrSignature: "getCirculatingSupply"): TypedContractMethod<[], [bigint], "view">;
    ...
    getFunction(nameOrSignature: "removeFromDenyList"): TypedContractMethod<[tokens: AddressLike[]], [void], "nonpayable">;
    getFunction(nameOrSignature: "renounceOwnership"): TypedContractMethod<[], [void], "nonpayable">;
    getFunction(nameOrSignature: "setAvatar"): TypedContractMethod<[_avatar: AddressLike], [void], "nonpayable">;
    getFunction(nameOrSignature: "setCirculatingSupply"): TypedContractMethod<[
        _circulatingSupply: AddressLike
    ], [
        void
    ], "nonpayable">;
    getFunction(nameOrSignature: "setCollection"): TypedContractMethod<[_collection: AddressLike], [void], "nonpayable">;
    ...
    getEvent(key: "ExitModuleSetup"): TypedContractEvent<ExitModuleSetupEvent.InputTuple, ExitModuleSetupEvent.OutputTuple, ExitModuleSetupEvent.OutputObject>;
    getEvent(key: "ExitSuccessful"): TypedContractEvent<ExitSuccessfulEvent.InputTuple, ExitSuccessfulEvent.OutputTuple, ExitSuccessfulEvent.OutputObject>;
    ...
    filters: {
        ...
        "ExitModuleSetup(address,address)": TypedContractEvent<ExitModuleSetupEvent.InputTuple, ExitModuleSetupEvent.OutputTuple, ExitModuleSetupEvent.OutputObject>;
        ExitModuleSetup: TypedContractEvent<ExitModuleSetupEvent.InputTuple, ExitModuleSetupEvent.OutputTuple, ExitModuleSetupEvent.OutputObject>;
        "ExitSuccessful(address)": TypedContractEvent<ExitSuccessfulEvent.InputTuple, ExitSuccessfulEvent.OutputTuple, ExitSuccessfulEvent.OutputObject>;
        ExitSuccessful: TypedContractEvent<ExitSuccessfulEvent.InputTuple, ExitSuccessfulEvent.OutputTuple, ExitSuccessfulEvent.OutputObject>;
